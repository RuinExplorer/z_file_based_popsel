/* Formatted on 1/16/2018 10:25:06 AM (QP5 v5.313) */
--testing load
...
BEGIN
    ...
    BANINST1.Z_POPSEL.P_LOAD_POPSEL_FROM_FILE (P_FOLDER_NAME,
                                               P_FILE_NAME,
                                               P_APPLICATION,
                                               P_SELECTION,
                                               P_CREATOR,
...
SELECT *
 ...
 WHERE     glbextr_application = 'STUDENT'
       AND glbextr_selection = 'POPSEL_TEST'
       AND glbextr_user_id <> 'A00350677';
...
BEGIN
    ...
    BANINST1.Z_POPSEL.P_PURGE_POPSEL (P_APPLICATION,
                                      P_SELECTION,
                                      P_CREATOR,
                                      P_USER_ID);
    COMMIT;
